    ...
    public static void main(String[] args) throws IOException {
        ...
        server.createContext("/add",new HttpHandler(){
            ...
            public void handle(HttpExchange exchange)throws IOException{
                ...
                String task = URLDecoder.decode(params[0].split("=")[1], "UTF-8");
                String description = params.length > 1 ? URLDecoder.decode(params[1].split("=")[1], "UTF-8") : "";

                //store the task
                todoList.add(new Task(task, description));
        ...
        server.createContext("/edit",new HttpHandler(){
                ...
                public void handle(HttpExchange exchange)throws IOException{
                    ...
                    //this tells what task to edit 
                     ...
                     //updated task name
                     String newTaskName=URLDecoder.decode(params[1].split("=")[1], "UTF-8");
                     String newdescription = params.length > 2 ? URLDecoder.decode(params[2].split("=")[1], "UTF-8") : "";
                    Task task=todoList.get(index-1);
